...
#-----------------------------------------------------------------------------------------------------------------
#
# Docs: https://github.com/bartventer/devcontainer-features/tree/main/src/aws-cli/README.md
...
check_packages curl ca-certificates gnupg unzip
...
install() {
    ...
    case "${architecture}" in
        x86_64) architectureStr=x86_64 ;;
        aarch64) architectureStr=aarch64 ;;
        *)
