...
test-global: ## Run global scenario tests.
	$(DEVCONTAINER_TEST) $(DEVCONTAINER_TEST_GLOBAL_FLAGS) $(PATH_TO_RUN) || $(call error_exit,"Failed to run global scenario tests")
...
test-autogenerated: ## Run autogenerated tests for a specific feature against a base image. Arguments: FEATURES, BASE_IMAGE.
	$(DEVCONTAINER_TEST) $(DEVCONTAINER_TEST_AUTOGENERATED_FLAGS) $(PATH_TO_RUN) || $(call error_exit,"Failed to run autogenerated tests")

.PHONY: test-scenarios
test-scenarios: ## Run scenario tests for a specific feature. Argument: FEATURES.
	$(DEVCONTAINER_TEST) $(DEVCONTAINER_TEST_SCENARIOS_FLAGS) $(PATH_TO_RUN) || $(call error_exit,"Failed to run scenario tests")